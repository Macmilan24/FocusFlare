  ...
  useEffect(() => {
    if (state?.message) {
      if (state.isError) {
        ...
        // Success toast is handled by redirect logic, but you could add one here if needed
      }
    }
  }, [state]);
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-yellow-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">Welcome back, super learner! 🌟</p>
        </div>

        <Card className="shadow-lg border-2 border-orange-100">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-bold text-foreground">Login to Learn!</CardTitle>
          ...
          <CardContent className="space-y-6">
            ...
            <form action={formAction} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="loginId" className="text-base font-medium">Email or Username</Label>
                <Input
                  id="loginId"
                  name="loginId"
                  type="text"
